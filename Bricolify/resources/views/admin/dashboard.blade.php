...
<div class="max-w-7xl mx-auto px-6 lg:px-8 py-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-3xl border border-slate-200/60 p-6 shadow-sm">
            ...
            <div class="text-3xl font-extrabold text-slate-900">4,204</div>
        ...
        <div class="bg-white rounded-3xl border border-slate-200/60 p-6 shadow-sm">
            ...
            <div class="text-3xl font-extrabold text-slate-900">852</div>
        ...
        <div class="bg-white rounded-3xl border border-slate-200/60 p-6 shadow-sm relative overflow-hidden group border-amber-200">
            ...
            <div class="relative z-10">
                ...
                <div class="text-3xl font-extrabold text-slate-900">14</div>
        ...
        <div class="bg-white rounded-3xl border border-slate-200/60 p-6 shadow-sm">
            ...
            <div class="text-3xl font-extrabold text-slate-900">MAD 45k</div>
